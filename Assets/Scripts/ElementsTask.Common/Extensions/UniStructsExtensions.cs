...
namespace ElementsTask.Common.Extensions
{
...
#region Transform
        ...
        public static TComponent GetClosest<TComponent>(
            this Transform transform, 
            IEnumerable<TComponent> other, 
            Vector3 offset = new Vector3()) where TComponent : Component
        {
        ...
        public static void LookAt2D(this Transform transform, Vector3 worldPosition, float maxZRotation)
        {
            ...
            transform.rotation = Quaternion.Euler(0f, 0f, 
                Mathf.Clamp(targetRotationZ, targetRotationZ - maxZRotation, targetRotationZ + maxZRotation));
        }
